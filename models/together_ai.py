...
def mistral_response(query,WEAVIATE_HOST):
...
def request_mistral_sop(query):
    WEAVIATE_HOST = os.environ['WEAVIATE_HOST_SOP']
    return mistral_response(query,WEAVIATE_HOST)

def request_mistral_sop_and_chat_history(query):
    WEAVIATE_HOST = os.environ['WEAVIATE_HOST_SOP_CHAT']
    return mistral_response(query,WEAVIATE_HOST)